...
if ($_GET["area"]=="devon")
{
  ...
  $areaArray = array("43-111DEVCallAdv.txt","44-111DEVClinAdv.txt");
...
if ($_GET["area"]=="staffordshire")
{
  ...
  $areaArray = array("3-111ClinAdv.txt","37-111SUPSTF.txt","14-111STFCallAdv.txt");
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php?area=staffs"><span id="clock" style="padding-right:20px;">&nbsp;</span> <?php echo $title ?> NHS 111 </a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav" style="width: 200px; float:right">
            
           <li><a href="#" style="color: #ff0000">TEST VERSION</a></li>
            <li><a href="help.php?area=staffs">HELP</a></li>
